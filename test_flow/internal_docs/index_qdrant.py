...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--input", type=Path, default=Path("chunks/chunks_parent_child.jsonl"))
    ...
    p.add_argument("--embedding-provider", choices=["huggingface", "openai"], default="openai")
    p.add_argument("--model", type=str, default=DEFAULT_OPENAI_EMBEDDING_MODEL)
