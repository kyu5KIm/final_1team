...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", type=Path, default=Path("chunks/chunks_parent_child.jsonl"))
    ...
    parser.add_argument("--chunk-version", type=str, default="local_parent_child_650")
